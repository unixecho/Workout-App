...
const PATTERNS: Record<string, Pattern> = {
  ...
  // ---- Machine library completion (2026-07 pass) --------------------------
  abduction: {
    // front view, seated: legs press apart against the pads
    a: { head: [62, 24], bones: ["42,68 82,68", "62,32 62,64", "62,64 57,78 55,90", "62,64 67,78 69,90", "52,40 62,36 72,40"] },
    b: { head: [62, 24], bones: ["42,68 82,68", "62,32 62,64", "62,64 46,74 38,86", "62,64 78,74 86,86", "52,40 62,36 72,40"] },
  },
  adduction: {
    // front view, seated: legs squeeze together against the pads
    a: { head: [62, 24], bones: ["42,68 82,68", "62,32 62,64", "62,64 46,74 38,86", "62,64 78,74 86,86", "52,40 62,36 72,40"] },
    b: { head: [62, 24], bones: ["42,68 82,68", "62,32 62,64", "62,64 57,78 55,90", "62,64 67,78 69,90", "52,40 62,36 72,40"] },
  },
  reversefly: {
    // chest on the pad: arm sweeps from hanging forward to rear-high
    a: { head: [50, 26], bones: ["44,68 84,68", "54,34 62,62", "62,62 78,64", "78,64 78,88", "56,38 46,48 38,58"] },
    b: { head: [50, 26], bones: ["44,68 84,68", "54,34 62,62", "62,62 78,64", "78,64 78,88", "56,38 70,34 82,30"] },
  },
  kickback: {
    // holding the support, working leg drives back and up
    a: { head: [56, 20], bones: ["88,30 88,92", "56,28 60,56", "60,56 60,74 60,92", "60,56 56,72 54,88", "57,34 86,38"] },
    b: { head: [52, 22], bones: ["88,30 88,92", "54,30 60,56", "60,56 60,74 60,92", "60,56 44,62 30,58", "56,36 86,38"] },
  },
  pullover: {
    // straight arm sweeps from overhead down to the thighs
    a: { head: [56, 18], bones: ["58,26 62,56", "62,56 62,74", "62,74 62,92", "62,92 74,92", "59,32 74,22 88,14"] },
    b: { head: [56, 18], bones: ["58,26 62,56", "62,56 62,74", "62,74 62,92", "62,92 74,92", "59,32 72,48 80,62"] },
  },
  overheadext: {
    // elbow pinned by the ear: forearm folds behind the head, extends up
    a: { head: [62, 20], bones: ["62,28 62,56", "62,56 62,74", "62,74 62,92", "62,92 74,92", "62,32 72,16 54,12"] },
    b: { head: [62, 20], bones: ["62,28 62,56", "62,56 62,74", "62,74 62,92", "62,92 74,92", "62,32 72,16 78,4"] },
  },
  seatedcalf: {
    // seated with the pad on the knees: heels rise, toes stay planted
    a: { head: [48, 30], bones: ["40,66 88,66", "50,38 62,62", "62,62 80,62", "80,62 80,88 90,88", "52,42 70,58"] },
    b: { head: [48, 30], bones: ["40,66 88,66", "50,38 62,62", "62,62 80,58", "80,58 82,82 90,88", "52,42 70,58"] },
  },
};
